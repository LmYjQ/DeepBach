    ...
    def make_tensor_dataset(self):
        ...
        for chorale_id, chorale in tqdm(enumerate(self.iterator_gen()),
            ...
            for offsetStart in np.arange(
                ...
                # Compute voice range for this subsequence
                ...
                # Determine transposition range for this subsequence
                ...
                for semi_tone in range(min_transposition_subsequence,
                    ...
                    try:
                        ...
                        chorale_tensor_dataset.append(local_chorale_tensor)
                        metadata_tensor_dataset.append(local_metadata_tensor)
